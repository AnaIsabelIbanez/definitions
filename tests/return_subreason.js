...
/**
 * Test for /return_subreason
 */
Test('/return_subreason', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getKeyValueList get operation', function (t) {
            Mockgen().requests({
                path: '/return_subreason',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/return_subreason']['get']['responses']['200']['schema']);
