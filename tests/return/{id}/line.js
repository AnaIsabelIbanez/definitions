...
/**
 * Test for /return/{id}/line
 */
Test('/return/{id}/line', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getLines get operation', function (t) {
            Mockgen().requests({
                path: '/return/{id}/line',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/return/{id}/line']['get']['responses']['200']['schema']);
