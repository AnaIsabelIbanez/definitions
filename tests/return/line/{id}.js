...
/**
 * Test for /return/line/{id}
 */
Test('/return/line/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test updateLine patch operation', function (t) {
            Mockgen().requests({
                path: '/return/line/{id}',
                operation: 'patch'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/return/line/{id}']['patch']['responses']['200']['schema']);
         ...
         * responses: 200, default
         */
        t.test('test updateLine get operation', function (t) {
            Mockgen().requests({
                path: '/return/line/{id}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    t.ok(res.statusCode === 200, 'Ok response status');
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/return/line/{id}']['get']['responses']['200']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
