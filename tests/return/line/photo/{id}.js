...
/**
 * Test for /return/line/photo/{id}
 */
Test('/return/line/photo/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test deletePhoto delete operation', function (t) {
            Mockgen().requests({
                path: '/return/line/photo/{id}',
                operation: 'delete'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/return/line/photo/{id}']['delete']['responses']['200']['schema']);
