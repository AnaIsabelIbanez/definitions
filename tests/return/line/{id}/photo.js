...
/**
 * Test for /return/line/{id}/photo
 */
Test('/return/line/{id}/photo', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test addPhoto post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/return/line/{id}/photo']['post']['responses']['200']['schema']);
